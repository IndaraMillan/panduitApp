...
var update = function () {
    ...
    comment = $("#leadermessage").val();
    var newcomment = comment
    $("#teammesssage").text(newcomment);
...
function activity(value) {
   ...
   var redirecCharts = function (){
     ...
     window.location.href = "/panduit/userCharts.html";
